    ...
    <div class="sidebar-content" data-simplebar style="height: calc(100% - 60px);">
        ...
        <ul class="sidebar-menu pt-3">
            <c:if test="${sessionScope.account.status == 1}">
                <li><a href="dashboard?action=home"><i class="uil uil-dashboard me-2 d-inline-block"></i>Dashboard</a></li> <!-- statistic -->
                ...
                <li><a href="doctormanage?action=all"><i class="uil uil-apps me-2 d-inline-block"></i>Blogs</a></li> <!-- statistic -->
                <li><a href="patientmanage?action=all"><i class="uil uil-users-alt me-2 d-inline-block"></i>Clubs</a></li> <!-- add new club -->
