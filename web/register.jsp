                                        ...
                                        <div class="col-12 mt-8">
                                            <div class="d-grid">    
                                                <a href="https://accounts.google.com/o/oauth2/auth?scope=email 
                                                   profile openid &redirect_uri=http://localhost:8080/Iter2/logingoogle&response_type=code &client_id=754575437351-ll510639upa1os3lpv867iad3n9a1anr.apps.googleusercontent.com&approval_prompt=force" class="btn btn-soft-primary"><i class="uil uil-google"></i> Google</a>
                                            </div>
                                        </div>
