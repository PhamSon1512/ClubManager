...
public class ContactListController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // Token validation is optional here, remove if not needed
        ...
        List<Contact> pendingContacts = contactDAO.getPendingContacts();
        request.setAttribute("contacts", pendingContacts);
