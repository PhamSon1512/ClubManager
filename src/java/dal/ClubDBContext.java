...
import controller.manager.ClubManager;
...
>>>>>>> 80dba93543cc60b39893f5953298acc9ab59e655
        ...
        try (Connection conn = getConnection(); PreparedStatement stmt = conn.prepareStatement(sql)) {
            ...
            try (ResultSet rs = stmt.executeQuery()) {
                while (rs.next()) {
                    ...
                    dept.setMemberCount(rs.getInt("member_count"));
                    dept.setCurrentProjects(rs.getString("current_projects"));
                    dept.setAchievements(rs.getString("achievements"));
    ...
    public List<ClubMember> getClubMembersByClubId(int clubId) {
        ...
        String sql = "SELECT cm.club_id, cm.user_id, cm.email, cm.speciality_id, cm.status, u.full_name, u.user_name, u.avatar_url "
                + "FROM club_member cm "
...
>>>>>>> 80dba93543cc60b39893f5953298acc9ab59e655
    ...
    public static void main(String[] args) {
        ClubDBContext dao = new ClubDBContext();
        System.out.println(dao.getClubIdByEmail("sadcdsv"));
    }
}
